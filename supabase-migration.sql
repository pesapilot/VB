-- Wise Village Banking Database Migration
-- From v1 (single group) to v2 (multi-group platform)
...
-- Drop triggers on auth.users first (always exists)
...
DROP TABLE IF EXISTS social_fund CASCADE;
...
CREATE TRIGGER on_group_request_update
...
-- ============================================
-- DONE! 
-- Now promote your first super admin:
-- UPDATE profiles SET platform_role = 'super_admin' WHERE email = 'your-email@example.com';
-- ============================================
